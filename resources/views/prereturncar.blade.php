...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
    ...
    <div class="container">
        <div class="jumbotron">
            <h1 class="text-center">Silahkan Lakukan Pengembalian Mobil Disini</h1>
            <p class="text-center"> Kami Berharap Anda Menikmati Pelayanan Kami </p>
        </div>
    </div>

    <div class="table-responsive" style="padding-left: 180px; padding-right: 50px;">
            ...
            <tbody>
                @foreach ($pesanan as $item)
                    <tr>
                        ...
                        <td>{{ $item->harga }}</td>                        
                        <td>
                            <a href="/return/{{ $item->id }}" onclick="return confirm('Apa anda ingin mengkonfirmasi pengembalian sekarang?')"><button class="btn btn-info">Return</button></a>
                        </td>
                    </tr>
                @endforeach
            </tbody>
