...
<head>
    <title> View Report | HiCar Rentals </title>
...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
    ...
    <div class="container">
        <div class="jumbotron">
            <h1 class="text-center">Laporan Sewa</h1>
        </div>
    </div>

    <div class="table-responsive" style="padding-left: 150px; padding-right: 10%;">
        <table class="table table-striped">
            ...
            <tbody>
                ...
                @php
                    $tgl_kembali = \Carbon\Carbon::createFromDate($item->tgl_kembali);
                    $tgl_rental = \Carbon\Carbon::createFromDate($item->tgl_pinjam);
