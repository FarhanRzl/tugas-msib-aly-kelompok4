...
<body>
    ...
    <div class="container" style="margin-top: 65px;">
        <div class="col-md-7" style="float: none; margin: 0 auto;">
            <div class="form-area">
                <form role="form" action="/adddriver" enctype="multipart/form-data" method="POST">
                    @csrf
                    <br style="clear: both">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control" id="car_name" name="driver_name"
                            placeholder="Nama Driver " required autofocus="">
                    </div>
                    ...
                    <div class="form-group">
                            <select name="driver_gender" id="ac_price"class="form-control" placeholder="Jenis Kelamin" required>
                                <option selected hidden>Pilih Jenis Kelamin</option>
                                <option type="radio" name="jenis_kelamin" value="Laki-laki"> Laki-laki<br>
                                <option type="radio" name="jenis_kelamin" value="Perempuan"> Perempuan<br>
                            </select>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="admin_id" class="form-control" aria-label="Default select example">
                            <option selected hidden>Pilih Admin</option>
        ...
        <div class="col-md-12" style="float: none; margin: 0 auto;">
            <div class="form-area" style="padding: 0px 100px 100px 100px;">
                <br style="clear: both">
                <h3 style="margin-bottom: 25px; text-align: center; font-size: 30px;"> My Driver </h3>
                        ...
                        <tbody>
                            @foreach ($driver as $item)
                                <tr>
                                    ...
                                    <td>
                                        <a href="/editdriver/{{ $item->id }}"><button class="btn btn-info">Edit</button></a>
                                        <a onclick="return confirm('Apa anda yakin?')" href="/delete/{{ $item->id }}">
