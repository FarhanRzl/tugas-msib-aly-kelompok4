...
<head>
    <title> Customer Signup | HiCar Rentals </title>
        ...
        <div class="col-md-5 col-md-offset-4">
            <div class="panel panel-danger">
                ...
                <div class="panel-body">
                    ...
                    <form role="form" action="/customerregister" method="POST">
                        @csrf
                        ...
                        <div class="row">
                            <div class="form-group col-xs-12">
                                <label for="customer_phone"><span class="text-danger"
                                        style="margin-right: 5px;">*</span> No. Telp: </label>
                                <div class="input-group">
                        ...
                        <label style="margin-left: 5px;"><a href="/customer">Login</a></label>
