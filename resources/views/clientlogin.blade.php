...
<html>
    ...
    <head>
        <title> Admin Login | HiCar Rentals </title>
    ...
    <body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
        ...
        <div class="container">
            <div class="jumbotron">
                <h1 class="text-center">HiCar Rentals - Admin Panel </span>
                </h1>
                <br>
    ...
    <div class="container" style="margin-top: -2%; margin-bottom: 2%;">
        <div class="col-md-5 col-md-offset-4">
            <label style="margin-left: 5px;color: red;"></label>
                    ...
                    <form action="/employee" method="POST">
                        ...
                        <div class="row">
                            <div class="form-group col-xs-12">
                                ...
                                <div class="input-group">
                                    <input class="form-control" id="client_username" type="text" name="username"
                        ...
                        <div class="row">
                            <div class="form-group col-xs-12">
                                ...
                                <div class="input-group">
                                    <input class="form-control" id="client_password" type="password" name="password"
                        ...
                        <label style="margin-left: 5px;"><a href="/signupemployee">Buat Akun</a></label>
                    </form>
                </div>
            </div>
        </div>
